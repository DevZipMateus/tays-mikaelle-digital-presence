      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6">
            <Button onClick={() => scrollToSection("services")} size="lg" className="bg-background text-foreground hover:bg-background/90 shadow-lg">
              Conheça nossos serviços
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <Button onClick={() => scrollToSection("contact")} size="lg" variant="outline" className="border-2 border-primary-foreground/60 text-primary-foreground bg-stone-950 hover:bg-stone-800">
              Entre em contato
            </Button>
          </div>
        </div>
